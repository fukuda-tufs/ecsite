...
public class AdminController {
	...
	public String goodsMst(LoginForm f, Model m) {
		System.out.println("Formの値[ユーザ名]: " + f.getUserName());
		System.out.println("Formの値[パスワード]: " + f.getPassword());
	...
	public String addGoods(GoodsForm goodsForm, LoginForm loginForm, Model m) {
		System.out.println("Formの値[ユーザ名]: " + loginForm.getUserName());
		System.out.println("Formの値[パスワード]: " + loginForm.getPassword());
